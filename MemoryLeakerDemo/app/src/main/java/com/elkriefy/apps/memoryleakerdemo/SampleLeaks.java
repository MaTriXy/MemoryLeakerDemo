...
public class SampleLeaks extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
     ...
     * across configuration changes. The VM has a reference to all running
    ...
    /**
     * Static nested classes don't hold implicit references to their outer class,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_sample_3, menu);
        return true;
    }
